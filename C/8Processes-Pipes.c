...
/* Merge sort the data.
I am using a global boolean to keep track of the original parent process. */
        ...
        if(parent == true && counter < 7){
            ...
            if(pid > 0){
                ...
                for(int i =0; i <left_block.size; i++){
                    write(*write_fd, &left_block.data[i], sizeof(int));
                }
                //printf("Ending write\n");
            }
            else{
                ...
                for(int i =0; i <left_block.size; i++){
                    ...
                    read(*read_fd, &left_block.data[i], sizeof(int));
                }
                //printf("Ending read\n");
                exit(EXIT_FAILURE);
            }
...
int main(int argc, char *argv[]) {
    ...
    if(parent == true){
        //printf("Made it here, parent value is: %d\n", parent);
